package com.webscare.urducanvas.ui.editor.panels.eraser
...
import com.webscare.urducanvas.databinding.FragmentUniversalEraserBinding
import dagger.hilt.android.AndroidEntryPoint

@AndroidEntryPoint
class UniversalEraserFragment : Fragment() {

    private var _binding: FragmentUniversalEraserBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentUniversalEraserBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    private fun ensureEraserSessionActive() {
    ...
    private fun updatePresetSelection(currentSize: Int) {
        ...
        val strokeColor = ContextCompat.getColor(context, R.color.appColor)
