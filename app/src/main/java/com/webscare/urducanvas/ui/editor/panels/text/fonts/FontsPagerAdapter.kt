...
class FontsPagerAdapter(
    fragment: Fragment,
    private var categories: List<com.webscare.urducanvas.data.model.FontLanguages>
    ...
    fun updateCategories(newCategories: List<com.webscare.urducanvas.data.model.FontLanguages>) {
