...
class FontLanguagesAdapter(
    ...
    private val fonts = mutableListOf<com.webscare.urducanvas.data.model.FontLanguages>()
    private val viewPool = RecyclerView.RecycledViewPool()

    fun submitList(newList: List<com.webscare.urducanvas.data.model.FontLanguages>) {
        fonts.clear()
    ...
    inner class FontViewHolder(private val binding: LayoutTabsFontLanguagesItemBinding) :
        ...
        fun bind(font: com.webscare.urducanvas.data.model.FontLanguages) {
