...
class ThumbnailAdapter(
    ...
    companion object {
        private val DIFF = object : DiffUtil.ItemCallback<SelectedItem>() {
            override fun areItemsTheSame(old: SelectedItem, new: SelectedItem) = old.uniqueId == new.uniqueId
            override fun areContentsTheSame(old: SelectedItem, new: SelectedItem) = old.uniqueId == new.uniqueId
        }
