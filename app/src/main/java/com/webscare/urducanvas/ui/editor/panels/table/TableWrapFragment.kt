...
import com.webscare.urducanvas.databinding.LayoutTableWrapOptionsBinding

class TableWrapFragment : Fragment() {

    private var _binding: LayoutTableWrapOptionsBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = LayoutTableWrapOptionsBinding.inflate(layoutInflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnAutoWidth.addPressEffect {
            viewModel.setTableContentWrap(true)
            updatePillSelection(binding.btnAutoWidth, binding.btnFixedWidth)
        }

        binding.btnFixedWidth.addPressEffect {
    ...
    companion object {
        fun newInstance() = TableWrapFragment()
    }
}
